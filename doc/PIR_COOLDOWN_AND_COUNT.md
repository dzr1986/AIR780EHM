...
> 框架上下文见 [T31X_4G_FRAMEWORK.md](T31X_4G_FRAMEWORK.md) §5。  
> 冷却间隔配置见 [PIR_TRIGGER_INTERVAL.md](PIR_TRIGGER_INTERVAL.md)。  
> AT 查询见 [T31X_4G_AT_INTERACTION.md](T31X_4G_AT_INTERACTION.md) §4～§5。
...
> **精简 vs 宽表**（`HOSTEVT?` / `PIRSTAT?` 分工、示例、能否合并）：见 [T31X_HOSTEVT_SLEEP.md §2](T31X_HOSTEVT_SLEEP.md)。
