...
> 硬件音频：T31x `HPOUT` / `SPEAK_EN`（见 [T31X_CAT1_GPIO.md](T31X_CAT1_GPIO.md) §2.4）  
> 协作框架：[T31X_4G_FRAMEWORK.md](T31X_4G_FRAMEWORK.md) · 唤醒：[T31X_HOSTEVT_PROTOCOL.md](T31X_HOSTEVT_PROTOCOL.md) · 低功耗：[LOW_BATTERY_AND_LOW_POWER.md](LOW_BATTERY_AND_LOW_POWER.md)
...
插 **USB（GPIO27）** 时：`battery_guard` 忽略低电量并保持 T31x 上电（见 [LOW_BATTERY_AND_LOW_POWER.md](LOW_BATTERY_AND_LOW_POWER.md)），**不因电量播关机音**。
...
7. **文档**：在 [T31X_4G_AT_INTERACTION.md](T31X_4G_AT_INTERACTION.md) 登记 `AT+PLAYSOUND`。
