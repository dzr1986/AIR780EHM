...
| 2013 ↔ 1013 上传视频信令 | 已实现（`001.000.015` + T31x `AT+UPLOADVIDEO`） | `dispatchDl2013` → 1013；T31x `clip_upload_request` | **一致** |
...
| 2002 exit 是否回 1002 | 3.2：退出不发 1002；第四节⑨又写「收 1002 exit」 | 以 `dispatchDl2002` 为准（enter 成功才 1002） | **文档自相矛盾**。客户端按 Lua：exit 不等 1002 |
| 需 T31x 的下行 | 2006/2007/2009/2012/2020–2031 | `HOST_DL_NEEDS_T31X`：2006/2007/2009/2020–2031（含 2028/2029） | 2012 走 PIR/录像逻辑，T31x 未就绪可能失败。日志常见 `host_not_ready` |
...
3. T31x 未上电时 2006/2007/编码类会排队或失败，属实现行为，不是 Broker 问题。
