...
> 这是 **4G 模组 USB 烧录**，不是 T31x GPIO28 烧录（见 [T31X_BURN_MODE.md](../hardware/T31X_BURN_MODE.md)）。
...
| [CAT1_TOOLCHAIN_TEST_REPORT.md](../_audit/CAT1_TOOLCHAIN_TEST_REPORT.md) | 烧完后 MQTT 自动测试 |
