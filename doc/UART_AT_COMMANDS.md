...
> **相关文档**：[UART_PROTOCOL.md](UART_PROTOCOL.md) · [T31X_CAT1_AT_COMMAND_SPEC.md](T31X_CAT1_AT_COMMAND_SPEC.md) · [T31X_4G_AT_INTERACTION.md](T31X_4G_AT_INTERACTION.md) · [MQTT_CLOUD_REMOTE_CTRL_FLOW.md](MQTT_CLOUD_REMOTE_CTRL_FLOW.md)（帧率/录像/人形）
...
| `AT+PIRSTAT` / `AT+PIRSTAT?` | `+PIRSTAT:` | **宽表**：PIR 策略、`cnt_*`、冷却 + 附带 `has_work`；运维/调试；见 [T31X_HOSTEVT_SLEEP.md §2](T31X_HOSTEVT_SLEEP.md) |
...
| `AT+HOSTIDLE?` / `AT+HOSTIDLE=0/1` | `+HOSTIDLE:` | 休眠门禁；见 [T31X_HOSTEVT_SLEEP.md](T31X_HOSTEVT_SLEEP.md) |
...
详见 [T31X_RECORD_MQTT_FLOW.md](T31X_RECORD_MQTT_FLOW.md)。
...
- 同一启动窗口内 T31x 连发多条 AT 时，仅首条触发开机音；详见 [BOOT_SHUTDOWN_SOUND.md](BOOT_SHUTDOWN_SOUND.md) §7.3
