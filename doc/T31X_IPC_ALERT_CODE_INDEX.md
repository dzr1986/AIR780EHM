...
`disk_full` · `time_sync` · `not_inited` · `no_record` · `open_failed` · `no_iframe` · `no_stream` · `failed` · `done` · `timer` · `cloud` · `pir_retrigger` · `allday_wait_person` 等 — 见 [T31X_RECORD_MQTT_FLOW.md](./T31X_RECORD_MQTT_FLOW.md)。
