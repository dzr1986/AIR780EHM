...
> **真源**：[CAT1_API_NAMING](../overview/CAT1_API_NAMING.md)（API 命名，对齐代码 **001.000.154**）· [T31X_NAMING](../overview/T31X_NAMING.md)（t31x/T31x/T31X 写法）· [LUA_MODULES](../overview/LUA_MODULES.md)（模块树）· [CONFIG](../overview/CONFIG.md)（配置键）
> **代码真源**：仓库根 `user/`、`lib/`。
