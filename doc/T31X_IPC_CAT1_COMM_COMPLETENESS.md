...
> 关联：[T31X_IPC_4G_INTERACTION.md](T31X_IPC_4G_INTERACTION.md)、[T31X_HOSTEVT_SLEEP.md](T31X_HOSTEVT_SLEEP.md)、[UART_AT_COMMANDS.md](UART_AT_COMMANDS.md)
...
配置：`HOST_USB_CFG`（`config.lua`）。完整时序：[T31X_LOW_POWER.md §2.1](T31X_LOW_POWER.md)。
...
`host_uart.lua` 的 `parse_record_line()` 已兼容两种格式。详见 [T31X_RECORD_MQTT_FLOW.md](T31X_RECORD_MQTT_FLOW.md)。
...
| [T31X_RECORD_MQTT_FLOW.md](T31X_RECORD_MQTT_FLOW.md) | 录像 MQTT 1010/1011 |
