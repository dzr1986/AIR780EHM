...
> **关联**：[CAT1_LOWPWR_MQTT_TCP_STRATEGY.md](CAT1_LOWPWR_MQTT_TCP_STRATEGY.md) · [REMOTE_ENCODE_CONFIG.md](../mqtt/REMOTE_ENCODE_CONFIG.md) · [CAT1_USER_LIB_SLIM.md](CAT1_USER_LIB_SLIM.md)
...
详见 [REMOTE_ENCODE_CONFIG.md](../mqtt/REMOTE_ENCODE_CONFIG.md)。
