...
> rest 重连时 conack 发 **1002 + 1003**，**不发 1001**。详见 [T31X_LOW_POWER.md](../power/T31X_LOW_POWER.md)。
...
配置优先级、迁移时序、PIR 触发端到端流程见 **[PIR_PROTOCOL.md §2.4 / §4](../pir/PIR_PROTOCOL.md#24-配置来源与持久化迁移)**。
...
详见 [PIR_PROTOCOL.md §2.4 / §4](../pir/PIR_PROTOCOL.md#24-配置来源与持久化迁移) · [T31X_RECORD_MQTT_FLOW.md](../pir/T31X_RECORD_MQTT_FLOW.md)。
