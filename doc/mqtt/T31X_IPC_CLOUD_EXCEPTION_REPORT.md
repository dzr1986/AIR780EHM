...
> **MQTT 后台具体 JSON / Topic / 恢复行为** → 专文 [T31X_IPC_EXCEPTION_MQTT_UPLINK.md](../t31x/T31X_IPC_EXCEPTION_MQTT_UPLINK.md)
...
详见 [T31X_RECORD_MQTT_FLOW.md](../pir/T31X_RECORD_MQTT_FLOW.md) · IPC 仓库 `docs/cat1_record_status_sync.md`。
...
| 文档 | 内容 |
| --- | --- |
| [T31X_IPC_ALERT_CODE_INDEX.md](../t31x/T31X_IPC_ALERT_CODE_INDEX.md) | **alertCode 逐条源码行号速查表** |
| [T31X_IPC_CAT1_SUPERVISION.md](../t31x/T31X_IPC_CAT1_SUPERVISION.md) | **Cat.1↔IPC 联合监督：架构、流程、源码索引、完善度** |
| [T31X_IPC_EXCEPTION_MQTT_UPLINK.md](../t31x/T31X_IPC_EXCEPTION_MQTT_UPLINK.md) | **MQTT 后台上行协议、JSON 示例、异常全表、恢复态说明** |
| [MQTT_PROTOCOL.md](MQTT_PROTOCOL.md) | 200x/100x 编号与 Topic 约定 |
| [T31X_RECORD_MQTT_FLOW.md](../pir/T31X_RECORD_MQTT_FLOW.md) | 1010/1011 录像会话时序 |
