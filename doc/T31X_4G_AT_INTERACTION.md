...
| `AT+RECORDCTRL=1/0` | MQTT **2012/2011** 直连开停录（T31x 在线） | [MQTT_CLOUD_REMOTE_CTRL_FLOW.md §4](MQTT_CLOUD_REMOTE_CTRL_FLOW.md#4-录像启停2011--2012) |
...
完整 4G→T31x 表见 [UART_AT_COMMANDS.md §3](UART_AT_COMMANDS.md#3-cat1--t31x4g-主动发t31x-答)。
