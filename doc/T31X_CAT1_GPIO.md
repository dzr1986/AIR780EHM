...
详细时序：[T31X_BURN_MODE.md](T31X_BURN_MODE.md) · USB 拔出与休眠：[T31X_USB_HOSTIDLE.md](T31X_USB_HOSTIDLE.md) · 低功耗决策：[POWER_USB_BATTERY_T31X_LOGIC.md](POWER_USB_BATTERY_T31X_LOGIC.md) · T31x 启停振荡分析：[T31X_BATTERY_USB_T31X_OSCILLATION.md](T31X_BATTERY_USB_T31X_OSCILLATION.md)（T31x 侧 PA9/VBUS 硬件见 IPC 仓 `docs/gpio_led_config.md`）
...
详细时序：[T31X_BURN_MODE.md](T31X_BURN_MODE.md) · 配置字段：[CONFIG.md](CONFIG.md)
