...
| 2026-09-05 | **L0 逐层重构（零行为）**：新增 `lib/power_hal`、`lib/adc_hal`、`gpio_util.getLevel`；user/ 10 处 pm/pmd/adc/gpio 直调 → 0；护栏 `_hal_layer_check.py`（run_all_checks #14）。计划见 [layer_refactor_plan.md](../../docs/layer_refactor_plan.md) L1 待做 |
