...
| [CAT1_LOGIC_SLIM.md](../power/CAT1_LOGIC_SLIM.md) | 历史 Flash/逻辑精简（另一套「阶段 4」= lib 去重） | 当历史账本，勿与架构计划「阶段 4」混名 |
| [CAT1_USER_LIB_SLIM.md](../power/CAT1_USER_LIB_SLIM.md) | 开关速查、勿合并大文件 | 口径已过期处（`app_config.lua`、384KB、体积数字）以本文 + 修订为准 |
| [CAT1_SLIMMING_FLOW.md](../power/CAT1_SLIMMING_FLOW.md) | 量产精简步骤、回归清单 | 烧录/验收仍走这里 |
...
详细场景仍见 [CAT1_SLIMMING_FLOW.md §6](../power/CAT1_SLIMMING_FLOW.md)。
