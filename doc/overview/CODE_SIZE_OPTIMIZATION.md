...
> **关联**：[CAT1_LOGIC_SLIM.md](../power/CAT1_LOGIC_SLIM.md)、[modules/PR_MERGE_REGRESSION.md](../modules/PR_MERGE_REGRESSION.md)
...
合并后按 [PR_MERGE_REGRESSION.md](../modules/PR_MERGE_REGRESSION.md) §4 与 [MQTT_CLIENT_E2E_TEST.md](../mqtt/MQTT_CLIENT_E2E_TEST.md) 抽测：
...
若仍超限，再评估 SKU 级裁剪（见 `doc/power/CAT1_SLIMMING_FLOW.md` §7）。
