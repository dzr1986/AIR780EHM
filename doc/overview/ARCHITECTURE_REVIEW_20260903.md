...
| `doc/overview/USER_LIB_FRAMEWORK_OPTIMIZATION_PLAN.md`（2026-08-31） | P4：`app.lua` **零拆分**；§6.3 新增子模块需四条件全满足；§7 阶段 C = 冻结 2 周（**进行中**） |
...
| # | 项 | 类型 | 收益 | 验收 | 状态 |
|---|---|---|---|---|---|
| L1 | 重写 `doc/overview/LUA_MODULES.md` 模块树与计数（73 文件、真实文件名单、修正 §3.x 引用） | 文档 | 新人 15 分钟定位任意 handler | 任意模块名 ≤2 次点击到文件 | ✅ **09-03 完成** |
...
| 项 | 位置 |
|---|---|
| 拆分后治理计划 | `doc/overview/USER_LIB_FRAMEWORK_OPTIMIZATION_PLAN.md` |
| 历史拆分账本 | `doc/overview/USER_LIB_OPTIMIZATION_NEXT.md` |
| 模块/事件总线专题 | `doc/overview/LUA_MODULES.md` · `doc/modules/APP_EVENT_BUS.md` |
