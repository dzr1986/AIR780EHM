...
- **裁剪**：config 片段 `flags.lua` → `MODULE_FLAGS`；见 [CAT1_USER_LIB_SLIM.md](../power/CAT1_USER_LIB_SLIM.md)  
...
| [POWER_USB_BATTERY_T31X_LOGIC.md](../power/POWER_USB_BATTERY_T31X_LOGIC.md) | 电量/USB/T31x 决策 |
| [LOW_POWER_ENTER_STRATEGY.md](../power/LOW_POWER_ENTER_STRATEGY.md) | rest vs HOSTIDLE |
| [MQTT_PROTOCOL.md](../mqtt/MQTT_PROTOCOL.md) | 上下行协议 |
| [MQTT_ALL_CMD_FLOW_TEST.md](../mqtt/MQTT_ALL_CMD_FLOW_TEST.md) | 全指令流程与实机结果 |
| [UART_AT_COMMANDS.md](../mqtt/UART_AT_COMMANDS.md) | AT 命令一览 |
