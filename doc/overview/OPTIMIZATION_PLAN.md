...
> **关联文档**：[LUA_MODULES.md](LUA_MODULES.md)（模块分析）· [CODE_ANALYSIS.md](CODE_ANALYSIS.md)（架构与风险）· [CAT1_LOGIC_SLIM.md](../power/CAT1_LOGIC_SLIM.md)（逻辑精简历史，阶段 0–4 已落地）· [CAT1_MODULE_FRAMEWORK.md](CAT1_MODULE_FRAMEWORK.md)（模块框架）
...
`doc/overview/CODE_ANALYSIS.md` 声称"lib 不反向依赖 user"，实际存在：
...
- [ ] **对账**：`doc/overview/CODE_DOC_AUDIT.md` 的代码↔文档核验流程跑一遍

详细场景见 [CAT1_SLIMMING_FLOW.md §6](../power/CAT1_SLIMMING_FLOW.md)。
