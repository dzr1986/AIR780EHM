...
> 本节讲「数据怎么流」（架构视角）；「代码按什么顺序执行、在哪个门禁被拦、在哪观测」的运行时视角见 [TECH_WORKFLOWS.md](TECH_WORKFLOWS.md)（W1–W10 与本节 6.1–6.6 一一对应）。
...
```
版本号双轨：脚本版 `001.000.158` ↔ IoT 版 `内核号.001.158`（`2034.001.158`），服务器统一 IoT 格式。详见 `ota_server/docs/OTA_FLOW.md`。
