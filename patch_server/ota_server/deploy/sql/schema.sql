...
CREATE TABLE IF NOT EXISTS devices (
    ...
    ipc_version     VARCHAR(32)  NULL,
    ipc_target_version VARCHAR(32) NULL,
    ipc_enabled     TINYINT(1)   NOT NULL DEFAULT 0,
    ipc_status      VARCHAR(32)  NULL DEFAULT 'IDLE',
    ipc_session_id  VARCHAR(64)  NULL,
    last_ipc_upgrade_at DATETIME(3) NULL,
